  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Manage categories, products, and curated looks.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <Link href="/admin/looks" className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:border-gray-300 hover:shadow">
          <h2 className="text-sm font-semibold text-gray-900">Looks</h2>
          <p className="mt-1 text-sm text-gray-500">Hero & lookbook curation</p>
        </Link>
      </div>
    </div>
  );
