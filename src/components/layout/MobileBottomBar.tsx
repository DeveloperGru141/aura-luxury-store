  ...
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 pointer-events-none">
      <div className="mx-auto max-w-7xl px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-2 bg-gradient-to-t from-black/40 to-transparent pointer-events-auto">
        <div className="flex items-center gap-2 rounded-2xl bg-white border border-[#E8DDD0] shadow-[0_8px_30px_rgba(0,0,0,0.12)] p-1.5">
          {/* Quick-filter toggle — 44px */}
          <button
            onClick={handleFilter}
            className="flex-1 min-h-[44px] inline-flex items-center justify-center gap-1.5 rounded-xl bg-[#FDFBF7] border border-[#E8DDD0] text-[#121212] text-xs font-semibold active:scale-95 transition-transform"
