  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden animate-fade-in">
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex pl-0 sm:pl-6 justify-end">
        <div className="w-[100vw] sm:w-screen max-w-[92vw] sm:max-w-md bg-[#11141A] border-l border-white/10 text-white shadow-2xl flex flex-col justify-between overflow-hidden animate-slide-in">
          {/* Header — fluid */}
