          ...
          {pillars.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="snap-start shrink-0 w-[235px] sm:w-auto flex flex-col items-center text-center p-3.5 sm:p-5 rounded-2xl bg-white border border-[var(--color-border)] hover:border-[var(--color-accent-gold)]/40 hover:shadow-[var(--shadow-elev-1)] active:scale-[0.97] transition-all duration-300 group touch-manipulation"
              >
