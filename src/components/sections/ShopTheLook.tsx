    ...
    return (
      <section id="lookbook" className="py-10 sm:py-14 lg:py-16 bg-[var(--color-surface-alt)] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <ScrollReveal className="flex flex-col mb-6 sm:mb-8">
    ...
    <section id="lookbook" className="py-10 sm:py-14 lg:py-16 bg-[var(--color-surface-alt)] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 lg:gap-6 items-start">
          <ScrollReveal delay={0.06} className="lg:col-span-8 w-full">
            <div
              onMouseEnter={() => setIsPaused(true)}
              onMouseLeave={() => setIsPaused(false)}
              onTouchStart={handleTouchStart}
              onTouchEnd={handleTouchEnd}
              className="relative aspect-[4/3] sm:aspect-[16/10] w-full rounded-2xl overflow-hidden border border-[var(--color-border)] bg-white group min-h-[280px] sm:min-h-[360px] touch-pan-y shadow-sm"
            >
          ...
          <ScrollReveal delay={0.12} className="lg:col-span-4 flex flex-col gap-4 w-full">
            {activeProduct && (
