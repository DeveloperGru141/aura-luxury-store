  ...
  return (
    <section id="vip" className="py-24 bg-gradient-to-b from-[#0A0C0F] via-[#12151D] to-[#0A0C0F] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        {/* Crown Icon */}
        <div className="w-14 h-14 rounded-2xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] flex items-center justify-center mx-auto mb-6 shadow-xl shadow-[#D4AF37]/10">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-3.5 rounded-xl bg-white/5 border border-white/15 text-sm text-white placeholder-gray-500 outline-none focus:border-[#D4AF37] transition-colors"
            />
            <button
              type="submit"
              className="py-3.5 px-6 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#B38F24] text-black font-semibold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:brightness-110 transition-all shadow-xl shadow-[#D4AF37]/10"
            >
