      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="lg:hidden pb-8">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <a href="#catalogue" className="py-3.5 px-6 rounded-full bg-black hover:bg-zinc-900 active:scale-[0.98] text-white font-semibold text-xs uppercase tracking-widest flex items-center justify-center gap-2 min-h-[44px] shadow-sm hover:shadow-md transition-all">
        ...
        <div className="hidden lg:grid lg:grid-cols-12 gap-8 xl:gap-10 items-center py-10 xl:py-14">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-7">
              <a href="#catalogue" className="py-3.5 px-7 rounded-full bg-black hover:bg-zinc-900 active:scale-[0.98] text-white font-semibold text-xs uppercase tracking-widest flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all min-h-[44px]">
                <span>Explore Collections</span>
                <ArrowRight className="w-4 h-4 shrink-0" />
              </a>
